...
(function (n, r) {
    ...
    return (
      null == r
        ...
        : (a(r),
          (n.type = r.type),
          r.geometries
            ? (n.geometries = r.geometries)
            : r.coordinates && (n.coordinates = r.coordinates),
  ...
  function a(n) {
    return n ? (z.hasOwnProperty(n.type) && z[n.type](n), n) : { type: null };
  }
  function i(n) {
    var r,
      t = n[0],
  ...
  function h(n, r) {
    function t(n, r) {
      r.length && r.pop();
      for (var t = f[n < 0 ? ~n : n], e = 0, o = t.length; e < o; ++e)
        r.push(u(t[e].slice(), e));
      n < 0 && Q(r, o);
    }
    function e(n) {
      return u(n.slice());
    ...
    function c(n) {
      ...
      switch (t) {
        case "GeometryCollection":
          return { type: t, geometries: n.geometries.map(c) };
        case "Point":
          r = e(n.coordinates);
          break;
        case "MultiPoint":
  ...
  function g(n, r, t) {
    ...
    else for (o = 0, e = new Array((a = n.arcs.length)); o < a; ++o) e[o] = o;
    return { type: "MultiLineString", arcs: Y(n, e) };
  }
  function v(n, r, t) {
    function e(n) {
      var r = n < 0 ? ~n : n;
      (l[r] || (l[r] = [])).push({ i: n, g: u });
    }
    function o(n) {
      n.forEach(e);
    }
  ...
  function p(n) {
    for (var r, t = -1, e = n.length, o = n[e - 1], a = 0; ++t < e; )
      (r = o), (o = n[t]), (a += r[0] * o[1] - r[1] * o[0]);
    return Math.abs(a);
  }
  function y(n, r) {
    function t(n) {
    ...
    function o(r) {
      return p(h(n, { type: "Polygon", arcs: [r] }).coordinates[0]);
    }
    var a = {},
      i = [],
      c = [];
      ...
      }),
      {
        ...
        arcs: c.map(function (r) {
          ...
          if (
            ...
            for (var i, c, u = 1, f = o(e[0]); u < t; ++u)
              (i = o(e[u])) > f &&
                ((c = e[0]), (e[0] = e[u]), (e[u] = c), (f = i));
          return e;
        }),
      }
    );
  ...
  function d(n) {
    var r = n[0],
      ...
      e = n[2];
    return Math.abs(
      (r[0] - e[0]) * (t[1] - r[1]) - (r[0] - t[0]) * (e[1] - r[1])
    );
  }
  function m(n) {
    for (var r, t = -1, e = n.length, o = n[e - 1], a = 0; ++t < e; )
  ...
  function P(n, r) {
    ...
    for (i = 1, c = n.length; i < c; ++i)
      (l = n[i]),
        ...
        (v = bn(h)),
        (u = a * v),
        (f += yn(u * bn(e), o * g + u * dn(e)));
    return (
      (f = 2 * (f > ln ? f - sn : f < -ln ? f + sn : f)),
      r && (f *= -1),
      f < 0 ? f + hn : f
    );
  }
  function w(n) {
    ...
    return (
      ...
      pn(
        En(
          mn(0, Mn(y / 2) * Mn((y - g) / 2) * Mn((y - v) / 2) * Mn((y - p) / 2))
        )
      )
    );
  }
  ...
  var x = function (n) {
    ...
    A = function (n, r, t, e, o) {
      ...
      for (
        var u = new e(
            (n = 1 << Math.max(4, Math.ceil(Math.log(n) / Math.LN2)))
          ),
          f = n - 1,
          l = 0;
        l < n;
    ...
    L = function (n, r, t, e, o, a) {
      ...
      for (
        ...
        l[g] = o;
      return { set: i, maybeSet: c, get: u, keys: f };
    },
    S = function (n, r) {
    ...
    I = function (n) {
      ...
      function t() {
        for (
          var n = L(1.4 * l.length, e, o, Int32Array, -1, Int32Array),
            r = new Int32Array(l.length),
            t = 0,
            a = l.length;
          t < a;
          ++t
      ...
      for (a = 0, i = h.length; a < i; ++a) {
        var P = h[a],
          w = P[0] + 1,
          k = P[1];
        for (c = g[k - 1], u = g[w - 1], f = g[w], r(a, c, u, f); ++w <= k; )
          r(a, (c = u), (u = f), (f = g[w]));
      }
      v = p = y = null;
      var x,
    ...
    F = function (n) {
      ...
      for (e = 0, o = c.length; e < o; ++e)
        for (var f = c[e], l = f[0], s = f[1]; ++l < s; )
          a.has(i[l]) &&
            ((t = { 0: l, 1: f[1] }), (f[1] = l), (f = f.next = t));
      for (e = 0, o = u.length; e < o; ++e)
        for (
          var h = u[e], g = h[0], v = g, p = h[1], y = a.has(i[g]);
          ++v < p;

        )
          a.has(i[v]) &&
            (y
              ? ((t = { 0: v, 1: h[1] }), (h[1] = v), (h = h.next = t))
              : (r(i, g, p, p - v), (i[p] = i[g]), (y = !0), (v = g)));
      return n;
    },
    O = function (n) {
      function r(n) {
      ...
      function e(n, r) {
        var t = n[0],
          ...
          a = r[1];
        if (t - o !== e - a) return !1;
        for (; t <= o; ++t, ++e) if (!S(h[t], h[e])) return !1;
        return !0;
      }
      function o(n, r) {
        var t = n[0],
          ...
          a = r[1];
        if (t - o !== e - a) return !1;
        for (; t <= o; ++t, --a) if (!S(h[t], h[a])) return !1;
        return !0;
      }
      function a(n, r) {
        var t = n[0],
      ...
      for (l = 0, s = v.length; l < s; ++l) for (f = v[l]; (f = f.next); ) ++p;
      var y = L(2 * p * 1.4, G, S),
        d = (n.arcs = []);
    ...
    N = function (n) {
      for (var r = n.arcs, t = -1, e = r.length; ++t < e; )
        for (
          var o, a, i = r[t], c = 0, u = i.length, f = i[0], l = f[0], s = f[1];
          ++c < u;
    ...
    U = {
      ...
      FeatureCollection: function (n) {
        return (
          ...
          (n.geometries = n.features),
          n.features.forEach(o),
          delete n.features,
          n
        );
      },
    ...
    z = {
      GeometryCollection: function (n) {
        for (var r = n.geometries, t = -1, e = r.length; ++t < e; )
          r[t] = a(r[t]);
      },
      MultiPoint: function (n) {
        n.coordinates.length
          ? n.coordinates.length < 2 &&
            ((n.type = "Point"), (n.coordinates = n.coordinates[0]))
          : ((n.type = null), delete n.coordinates);
      },
      LineString: function (n) {
      ...
      MultiLineString: function (n) {
        ...
        e
          ? e < 2
            ? ((n.type = "LineString"), (n.coordinates = r[0]))
            : (n.coordinates.length = e)
          : ((n.type = null), delete n.coordinates);
      },
      Polygon: function (n) {
        for (var r = n.coordinates, t = 0, e = 0, o = r.length; t < o; ++t) {
      ...
      MultiPolygon: function (n) {
        ...
        e
          ? e < 2
            ? ((n.type = "Polygon"), (n.coordinates = r[0]))
            : (r.length = e)
          : ((n.type = null), delete n.coordinates);
      },
    },
    R = function (n, r, t) {
      function e(n) {
        return (
          (n[0] = Math.round((n[0] - i) * l)),
          (n[1] = Math.round((n[1] - c) * s)),
          n
        );
      }
      function o(n) {
      ...
      return { scale: [1 / l, 1 / s], translate: [i, c] };
    },
    V = function (n, r) {
      function t(n) {
        n && h.hasOwnProperty(n.type) && h[n.type](n);
      ...
      (n = f.objects),
        (f.bbox = a),
        (f.arcs = f.arcs.map(function (n, r) {
          return s.set(n, r), l.slice(n[0], n[1] + 1);
        })),
        delete f.coordinates,
        (l = null);
      var h = {
        GeometryCollection: function (n) {
          n.geometries.forEach(t);
      ...
      function t(n) {
        switch (n.type) {
          case "Polygon":
            ...
            break;
          case "MultiPolygon":
            (n.arcs = n.arcs.map(e).filter(f)),
              n.arcs.length || ((n.type = null), delete n.arcs);
            break;
          case "GeometryCollection":
            n.geometries.forEach(t),
              (n.geometries = n.geometries.filter(l)),
              n.geometries.length || ((n.type = null), delete n.geometries);
        }
      }
      function e(n) {
    ...
    Q = function (n, r) {
      for (var t, e = n.length, o = e - r; o < --e; )
        (t = n[o]), (n[o++] = n[e]), (n[e] = t);
    },
    X = function (n, r) {
        ...
        for (var u = o[c], f = u.length, l = 0; l < f; ++l)
          for (var s = l + 1; s < f; ++s) {
            var h,
              g = u[l],
              v = u[s];
            (h = a[g])[(c = nn(h, v))] !== v && h.splice(c, 0, v),
              (h = a[v])[(c = nn(h, g))] !== g && h.splice(c, 0, g);
          }
      return a;
    },
    tn = function (n, r) {
      function t(n) {
        (n[0] = Math.round((n[0] - i) / c)),
          (n[1] = Math.round((n[1] - u) / f));
      }
      function e(n) {
        switch (n.type) {
          case "GeometryCollection":
      ...
      n.arcs.forEach(function (n) {
        for (
          var r,
            ...
            l = n.length,
            s = n[0],
            h = (s[0] = Math.round((s[0] - i) / c)),
            g = (s[1] = Math.round((s[1] - u) / f));
          o < l;
          ++o
        )
          (s = n[o]),
            (t = Math.round((s[0] - i) / c)),
            (e = Math.round((s[1] - u) / f)),
            (t === h && e === g) ||
              ((r = n[a++]), (r[0] = t - h), (h = t), (r[1] = e - g), (g = e));
        a < 2 && ((r = n[a++]), (r[0] = 0), (r[1] = 0)), (n.length = a);
      });
      for (o in n.objects) e(n.objects[o]);
      return (n.transform = { scale: [c, f], translate: [i, u] }), n;
    },
    en = function (n) {
      if (null == (r = n.transform)) return H;
      var r,
    ...
    on = function (n, r, t) {
      return (
        (r = null == r ? Number.MIN_VALUE : +r),
        null == t && (t = m),
        function (e, o) {
          return (
            t(
              X(n, { type: "Polygon", arcs: [e] }).geometry.coordinates[0],
              o
            ) >= r
          );
        }
      ...
      function r(n, r) {
        for (;;) {
          var t = (r + 1) << 1,
            ...
            c = e[i];
          if (
            (a < o && b(e[a], c) < 0 && (c = e[(i = a)]),
            t < o && b(e[t], c) < 0 && (c = e[(i = t)]),
            i === r)
          )
            break;
      ...
      return (
        ...
        n.arcs.forEach(function (n) {
          var i,
            ...
            f = [],
            l = 0;
          for (n.forEach(e), c = 1, u = n.length - 1; c < u; ++c)
            (i = n.slice(c - 1, c + 2)), (i[1][2] = r(i)), f.push(i), a.push(i);
          for (n[0][2] = n[u][2] = 1 / 0, c = 0, u = f.length; c < u; ++c)
            (i = f[c]), (i.previous = f[c - 1]), (i.next = f[c + 1]);
          for (; (i = a.pop()); ) {
            var s = i.previous,
              h = i.next;
            i[1][2] < l ? (i[1][2] = l) : (l = i[1][2]),
              s && ((s.next = h), (s[2] = i[2]), t(s)),
              h && ((h.previous = s), (h[0] = i[0]), t(h));
          }
          n.forEach(o);
        }),
        n
      ...
      return (
        ...
        n.arcs.forEach(
          n.transform
            ? function (n) {
                for (
                  var t, e, o = 0, a = 0, i = -1, c = -1, u = n.length;
                  ++i < u;
            ...
            : function (n) {
                for (var t, e = -1, o = -1, a = n.length; ++e < a; )
                  (t = n[e]), t[2] >= r && (n[++o] = t);
                n.length = ++o;
              }
        ),
          ...
          n.transform
            ? function (n) {
                var r = 0,
                  ...
                  o = n[0];
                for (o.length = 2; ++r < e; )
                  (o = n[r]), (o.length = 2), (o[0] || o[1]) && (n[++t] = o);
                n.length = (t || 1) + 1;
              }
            : function (n) {
                var r,
  ...
  (n.topology = V),
    ...
    (n.filterWeight = on),
    (n.planarRingArea = m),
    (n.planarTriangleArea = d),
    (n.presimplify = cn),
    (n.quantile = un),
    (n.simplify = fn),
    (n.sphericalRingArea = P),
    (n.sphericalTriangleArea = w),
    (n.bbox = K),
    (n.feature = X),
    (n.merge = $),
    (n.mergeArcs = y),
