...
class AllocationReport extends Component {
  constructor(props) {
    super(props);
    this.state = {
      columnDefs: [
        ...
        <Row className="mb-2 mt-2">
          <Col md={2}>
            ...
            {/* <Autocomplete
              ...
              getOptionLabel={(optionexe) => this.autoCompleteGetOptionLabel(optionexe)}
          ...
          <Col md={1}>
            ...
            />
            {/* <i className="fas fa-file-export" onClick={this.onBtnExportDataAsCsv.bind(this)}> </i> */}{" "}
          </Col>
        </Row>
        <div
