...
class UtilizedReport extends Component {
  constructor(props) {
    super(props);
    this.state = {
      columnDefs: [
  ...
  getPeriod() {
    axiosConfig
      ...
      .then(response => {
        ...
        //   this.setState({ periodData: Data })
        //   Data.forEach(item => {
        //     let ExecutionMonthId = item.executionmonth_id
        //     this.setState({ executionmonth_id: ExecutionMonthId })
        //   })
        // }
      })
      // .catch(err => {
  ...
  render() {
    //console.log(this.state.executionmonth_id)
    // console.log(this.state.executionmonth_id)
    return (
      <div>
        <h1>Utilization By Skill Report</h1>
