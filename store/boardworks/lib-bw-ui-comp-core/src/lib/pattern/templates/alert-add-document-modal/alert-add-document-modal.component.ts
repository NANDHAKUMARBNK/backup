...
@Component({
  selector: "bw-alert-add-document-modal",
  templateUrl: "./alert-add-document-modal.component.html",
  styleUrls: ["./alert-add-document-modal.component.scss"],
})
export class AlertAddDocumentModalComponent
