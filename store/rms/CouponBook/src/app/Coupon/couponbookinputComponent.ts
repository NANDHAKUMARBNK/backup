...
@Component({
    ...
    template: `<input #input maxlength="15" requiured  [(ngModel)]='value' style="width: 100%">`
})
export class CouponDetailInputEditorComponent implements ICellEditorAngularComp, AfterViewInit {
    private params: any;
    public value: any;
